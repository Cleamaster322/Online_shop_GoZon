...
import { LogOut, PlusCircle, ShoppingCart, Home, Boxes, ListOrdered } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#f4eeff] py-10 px-4">
      <div className="max-w-md mx-auto bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center gap-4">
        ...
        <h2 className="text-2xl font-bold text-center text-purple-800">{user.username}</h2>
        ...
        <div className="grid grid-cols-2 gap-3 w-full mt-4">
          ...
          <ActionButton onClick={() => navigate('/MyOrders')} Icon={ListOrdered} text="Заказы" />
        </div>
